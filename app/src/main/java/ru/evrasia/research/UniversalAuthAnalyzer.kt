...
internal object UniversalAuthAnalyzer {
    ...
    fun analyze(
        ...
        usedVariables.retainAll(bindings.map { it.variable }.toSet())
        ...
        val description = buildString {
            ...
            append("- Provenance policy: every exported non-seed request belongs to the causal component connected to the login root.\n")
