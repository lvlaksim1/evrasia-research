...
store_path = Path('app/src/main/java/ru/evrasia/research/NetworkDebugStore.kt')
correlator_path = Path('app/src/main/java/ru/evrasia/research/NetworkEventCorrelator.kt')

if correlator_path.exists():
    raise SystemExit('NetworkEventCorrelator.kt already exists')

store_path.write_text('''package ru.evrasia.research
...
correlator_path.write_text('''package ru.evrasia.research
